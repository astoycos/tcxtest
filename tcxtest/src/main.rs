use aya::programs::{SchedClassifier, TcAttachType, LinkOrder, tc::TcAttachOptions};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    program.load()?;
    let ordering = LinkOrder::first();
    let options = TcAttachOptions::tcxoptions(ordering);
